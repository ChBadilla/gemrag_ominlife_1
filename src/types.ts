...
// The InitChatPayload is now designed for connecting to a pre-existing persistent RAG store.
export interface InitChatPayload {
    ragStoreResourceName: string; // The full resource name of the pre-existing RAG store
    chatDisplayName: string;      // The display name for this chat session (e.g., "Omnilife Product Info")
